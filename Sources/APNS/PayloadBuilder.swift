...
public final class PayloadBuilder {
    ...
    /// Builder Pattern Closure
    public init(_ buildClosure: (PayloadBuilder) -> ()) {
        buildClosure(self)
    }
    ...
    public func build() -> Payload {
         ...
         let aps = APS(alert: alert,
                       ...
                       hasMutableContent: hasMutableContent ? 1 : 0)
         
        return Payload(aps: aps, threadId: threadId, extra: extra)
    }
}
